...
import { getCurrentDate, getLastWeekDateRange, parseDate } from "./commonUtils.js";

export const downloadXLSXWithLastWeekTasks =
    (api, bot) => {
        TaskSQL.all(
            (error, tasks) => {
                ...
                UserSQL.all(
                    (error, users) => {
                        ...
                        const filePath = `team_tasks_last_week_${getCurrentDate()}.xlsx`;
